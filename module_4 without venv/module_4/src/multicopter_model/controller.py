...
class QuadCopterController:
    ...
    def update(self, state_vector, dt, t_cur) -> np.ndarray:
        ...
        # режим стабилизации УСПЕШНО
        cmd_trust = 2100
        target_roll = 0.5             # радиан
        target_pitch = 0.5             # радиан
        self.target_yaw = 0.5          # радиан
    ...
    def _mixer(self, cmd_trust, cmd_roll, cmd_pitch, cmd_yaw) -> np.ndarray:
        u_0 = cmd_trust + cmd_roll - cmd_yaw        #TODO Реализуйте алгоритм смешивания команд
        u_1 = cmd_trust - cmd_pitch + cmd_yaw       #TODO 
        u_2 = cmd_trust - cmd_roll - cmd_yaw        #TODO 
        u_3 = cmd_trust + cmd_pitch + cmd_yaw       #TODO 
        return np.array([u_0, u_1, u_2, u_3])
