...
def main():
	...
	controller.roll_rate_controller.set_pid_gains(0.1, 0, 0)
	# controller.roll_rate_controller.set_saturation_limit(-7, 7)
	# controller.roll_rate_controller.integral_limit = 0.0

	controller.pitch_rate_controller.set_pid_gains(0.1, 0, 0)
	...
	# controller.yaw_rate_controller.set_saturation_limit(-7, 7)
